...
<head>
    ...
    <style>
        body{background-color: #c5c5c5; font: 14px sans-serif; }
        .wrapper{background-color: #fff;  border-radius: 10px; width: 360px; padding: 20px; text-align: center; margin: 175px auto;}
        .btn {width: 100%;}
        .login-image{margin: 100px -10; text-align: center;}
    </style>
</head>
<body>
    <div class="wrapper">
