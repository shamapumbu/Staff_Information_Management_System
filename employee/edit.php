<?php
    ...
    if(isset($_POST['update'])) {
        ...
        //updating value with that specific id will result in duplicates hence do not run query but print error message
            ...
            $sql_query = "UPDATE employee SET emp_id='$emp_id', first_name='$first_name', last_name='$last_name', date_of_birth='$date_of_birth', phone='$phone', home_address='$home_address', email='$email', password='$password', join_date='$join_date', gender='$gender', job_id='$job_id', branch_id='$branch_id', dept_id='$dept_id', project_no='$project_no', bonus='$bonus' WHERE emp_id='$emp_id_old'";
        ...
        <div class="container-fluid">
            ...
            <form action="edit.php" method="post">
                ...
                <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control" value="<?php echo $emp_id?>" name="emp_id"> 
                    </div>
                    <div class="form-group col-6">
